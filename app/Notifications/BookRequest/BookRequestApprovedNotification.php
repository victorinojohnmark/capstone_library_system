...
class BookRequestApprovedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ->line('Your book request for "'. $this->bookRequest->book->title. '" has been approved!')
    ...
    {
        return [
            'message' => 'Your book request for "'. $this->bookRequest->book->title. '" has been approved!',
